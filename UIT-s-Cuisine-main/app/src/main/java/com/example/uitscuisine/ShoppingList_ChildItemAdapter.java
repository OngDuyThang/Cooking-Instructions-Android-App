...
public class ShoppingList_ChildItemAdapter
        extends RecyclerView
        .Adapter<ShoppingList_ChildItemAdapter.ChildViewHolder> {

    private List<ShoppingList_ChildItem> ChildItemList;

    // Constructor
    ShoppingList_ChildItemAdapter(List<ShoppingList_ChildItem> childItemList)
    {
            ...
            int i)
    {
        ...
        View view = LayoutInflater
                ...
                .inflate(
                        R.layout.shopping_list_child_item,
                        viewGroup, false);
            ...
            int position)
    {
        ...
        ShoppingList_ChildItem childItem
