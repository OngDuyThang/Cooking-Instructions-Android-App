                ...
                checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                            ...
                            if(userEnteredUsername.equals(userFromDB)&&!userEnteredUsername.equals("Admin")){
                                ...
                                if(userEnteredPassword.equals("admin")){
                                    foundUser = true;Intent intent1 = new Intent(Login.this,Admin.class);
