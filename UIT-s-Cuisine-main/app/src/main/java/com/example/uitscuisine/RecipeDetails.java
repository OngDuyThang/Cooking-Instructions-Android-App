...
//                startActivity(intent);
    ...
    private void mapping() {
        ...
        ratingStar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float v, boolean b) {
                ...
                ratingText.setText("Rating: "+s);
            }
        });

    }
    public void RatingHandle(){

    }
    public void addShoppingList() {
        shareButton = (ImageButton) findViewById(R.id.shareButton);
        shareButton.setOnClickListener(this::AddShoppingList);
    }
    public void AddShoppingList(View view) {
        try {
            ...
            String nameRecipe = recipeName.getText().toString();
            String username = "BanhBao";
            Intent intent = getIntent();
            String recipeId_check = intent.getStringExtra("recipeId");
            ShoppingList shoppingList = new ShoppingList(username, recipeId_check, nameRecipe, ingredients, true);
            DatabaseReference database = FirebaseDatabase.getInstance().getReference("ShoppingList");
            Query checkList = database.orderByChild("idRecipe").equalTo(recipeId_check);
            checkList.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        alert.setMessage("This ingredients has already been in your List");
                        alert.setNeutralButton("Continue", new DialogInterface.OnClickListener() {
                            @Override
                        ...
                        database.child("Account List: " + username + " - Recipe: " + recipeId_check).setValue(shoppingList);
                        Toast.makeText(RecipeDetails.this, "Add new recipe successfully!", Toast.LENGTH_SHORT).show();
                        //Intent intent = new Intent(RecipeDetails.this, EditProfile.class);
                        Dialog.dismiss();
                        //startActivity(intent);
                    }
                }
