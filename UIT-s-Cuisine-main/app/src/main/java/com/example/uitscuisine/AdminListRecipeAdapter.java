...
public class AdminListRecipeAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private List<AdminListRecipe> list;
    public AdminListRecipeAdapter(Context context, int layout, List<AdminListRecipe> list) {
        this.context = context;
        this.layout = layout;
        this.list = list;
    }
    public void addListItemAdapter(ArrayList<AdminListRecipe> itemPlus) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        AdminListRecipeAdapter.ViewHolder holder;
        ...
        if (view == null) {
            ...
            holder = (AdminListRecipeAdapter.ViewHolder)view.getTag();
        }
        AdminListRecipe recipe;
        try{
            recipe = list.get(i);
